                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" id="defaultFormControlInput" name="description"
                                    placeholder="Deskripsi" aria-describedby="defaultFormControlHelp" value="{{ old('description') }}"/>
                            </div>
                            <div>
                                ...
                                <input type="text" class="form-control" id="defaultFormControlInput" name="link"
                                    placeholder="Link" aria-describedby="defaultFormControlHelp" value="{{ old('title') }}"/>
                            </div>
                        </div>
                    </div>
